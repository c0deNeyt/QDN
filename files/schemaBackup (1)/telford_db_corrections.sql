...
CREATE TABLE `corrections` (
  ...
  CONSTRAINT `fk_containments_analysis_tbl10` FOREIGN KEY (`analysis_tbl_id`) REFERENCES `analysis_tbl` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2021-04-25 23:07:27
