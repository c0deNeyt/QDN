$(document).ready(function () {
    ...
    //FUNCTION RESPONSIBLE FOR HANDLING EACH REASSIGNMENT 
        function reassignments(data, checkID){
            if (data){
                ...
                alert ("Something went wrong during reassignment, Check analysis.js line 47.");
            };
    ...
    // SELECTED BASE ON THE DATABSE
        function checkIfnotNUll2Db(arr, arrLen, toCheck){
        ...
        function qdnDetails(data) {
            if (data){
                ...
                function loadDataFromDb(data) {
                    ...
                    // PARSE THE DATA FROM DB TO HTML PAGE
                    if (des || COD || CODDes || failure_mode !== 0) {
                        //**CODE FOR DISPOSITION 
                        var failureMode = [$("#useAsIs"), $("#mcmr"), $("#rework"), $("#splitLot"), $("#shutdown"), $("#shipBack")];
