$(document).ready(function () {//*✅*/
    ...
    let makeItBlank = () => {
        let toBeBlank = ["ibName","ibTeam","itName","itTeam","customer","machine","pkgType","partName","station","lotId","teamResp","dateTime","classification","defects"];
     ...
     * Matched False: set the DOM TO default
         */
    function onLoadSearchEvent(requestNum, findThis){
        return{
            request() {
                return $.ajax({
                    type: 'POST',
